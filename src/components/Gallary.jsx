    ...
    <div  className="  container px-5 py-24 mx-auto flex flex-wrap">
      ...
      <div className="flex flex-wrap md:-m-2 -m-1 flex-col sm:flex-row w-full gap-2 ">
        <div className="flex flex-wrap sm:w-1/2 mx-auto w-full justify-between ">
          <div className="md:p-2 p-1 sm:w-[48%] border-4 group/portfolio border-indigo-600/50 relative overflow-hidden rounded-lg">
          ...
          <div className="md:p-2 group/portfolio overflow-hidden p-1 sm:w-[48%] mt-2 sm:mt-0 border-4 border-indigo-600/50 relative rounded-lg">
